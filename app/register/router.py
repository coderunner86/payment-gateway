...
async def register(
    ...
    """
    Asynchronous function for user registration with name, email, and password parameters.
    It creates a new user, checks for existing users, and handles user creation errors.
    """
